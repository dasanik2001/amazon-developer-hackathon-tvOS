...
export default function CustomDrawerContent(props: DrawerContentComponentProps) {
  ...
  const drawerItems = [
    { name: 'GuardianDashboard', label: '🛡️ Parent Briefing' },
    { name: 'GuardianQA', label: '💬 Ask AI' },
  ] as const;
      ...
      <View style={styles.drawerContainer}>
        ...
        >
          <View style={styles.header}>
            ...
            <Text style={styles.userName}>Aarav (Age 8)</Text>
            <Text style={styles.switchAccount}>Child Profile • Guardian Active</Text>
          </View>
